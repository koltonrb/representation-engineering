#!/bin/bash
#SBATCH --job-name=translate_en_es
#SBATCH --qos=standby
#SBATCH --requeue
...
# request 2 GPUs: the first GPU on m13l nodes is sometimes unavailable,
# which makes device_map="auto" silently fall back to (very slow) CPU
# inference instead of erroring — see honesty/run_honesty.sh history.
